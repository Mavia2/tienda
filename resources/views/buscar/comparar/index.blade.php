...
<div class="row">
  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-condensed table-hover" id="ex">
        <thead style="background-color: #ff8726 ;">           
          <th>Tienda - {{$album}}: Descripcion</th>         
          <th>Imagen</th>         
        </thead>
        @php $n=0;@endphp
        @foreach ($tienda as $sto)
  ...
  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-condensed table-hover" id="exxx">
        <thead style="background-color: #bef1e091">          
          <th>Moda - {{$album}}: Descripcion</th>         
          <th>Imagen</th>         
        </thead>
        @php $n=0;@endphp
        @foreach ($moda as $sto)

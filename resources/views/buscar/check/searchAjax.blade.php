...
<div class="form-group">
  <div class="input-group">
	...
	<button type="button" class="btn btn-primary" onclick="ant('#idd')"><</button></span>	
	 <span class="input-group-btn" style="padding-right:5px">   	
	<button type="button" class="btn btn-primary" onclick="sig('#idd')">></button></span>	
    ...
    <span class="input-group-btn">
      <button type="button"  class="btn btn-primary" onclick="buscarAjax('#searchText')">Buscar</button>
  </div>
</div>
